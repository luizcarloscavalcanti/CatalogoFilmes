...
class PopularMovieAdapterList(public val context: Context) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(FilmeDiffCallback()) {
    ...
    fun setInternetStatus(newInternetStatus: StatusInternet) {
        val previousState: StatusInternet? = this.internetStatus
        val hadExtraRow: Boolean = hasExtraRow()
        this.internetStatus = newInternetStatus
        ...
        } else if (hasExtraRow && previousState != newInternetStatus) {
